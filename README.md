...
<!-- VINTAGE:START -->
Regulation **M-C**. Ladder usage fetched 2026-09-22, from 333 Pokemon.
...
| `data/meta/usage_pokemon.json` | 333 | Ladder usage per Pokemon |
| `data/meta/usage_moves.json` | 440 | Ladder usage per move |
