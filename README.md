...
<!-- VINTAGE:START -->
Regulation **M-C**. Ladder usage fetched 2026-09-20, from 323 Pokemon.
...
| `data/meta/usage_pokemon.json` | 323 | Ladder usage per Pokemon |
| `data/meta/usage_moves.json` | 427 | Ladder usage per move |
