...
| **Find** | "Who learns Imprison *and* Wide Guard *and* Protect" — filters that stack, now including every stat, and sorting by one of them turns the same list into that stat's tier order. Plus **Worlds**: what the field actually brought, per championship |
